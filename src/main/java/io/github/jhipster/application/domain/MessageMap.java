...
public class MessageMap implements Serializable {
    ...
    @OneToMany(mappedBy = "messageMap")
    @Cache(usage = CacheConcurrencyStrategy.NONSTRICT_READ_WRITE)
    private Set<EnObject> messageObjects = new HashSet<>();
    ...
    public Set<EnObject> getMessageObjects() {
        return messageObjects;
    }

    public MessageMap messageObjects(Set<EnObject> enObjects) {
        this.messageObjects = enObjects;
        return this;
    }

    public MessageMap addMessageObjects(EnObject enObject) {
        this.messageObjects.add(enObject);
        enObject.setMessageMap(this);
        return this;
    }

    public MessageMap removeMessageObjects(EnObject enObject) {
        this.messageObjects.remove(enObject);
        enObject.setMessageMap(null);
        return this;
    }

    public void setMessageObjects(Set<EnObject> enObjects) {
        this.messageObjects = enObjects;
    }
