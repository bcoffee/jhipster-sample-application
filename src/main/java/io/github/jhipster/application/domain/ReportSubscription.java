...
public class ReportSubscription implements Serializable {
    ...
    @OneToOne    @JoinColumn(unique = true)
    private User reportSubscriptionUser;
    ...
    public User getReportSubscriptionUser() {
        return reportSubscriptionUser;
    }

    public ReportSubscription reportSubscriptionUser(User user) {
        this.reportSubscriptionUser = user;
        return this;
    }

    public void setReportSubscriptionUser(User user) {
        this.reportSubscriptionUser = user;
    }
