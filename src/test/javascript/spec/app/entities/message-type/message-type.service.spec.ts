...
describe('Service Tests', () => {
    describe('MessageType Service', () => {
        ...
        let elemDefault: IMessageType;
        beforeEach(() => {
            TestBed.configureTestingModule({
                imports: [HttpClientTestingModule]
            });
            injector = getTestBed();
            service = injector.get(MessageTypeService);
            httpMock = injector.get(HttpTestingController);

            elemDefault = new MessageType(0, 'AAAAAAA', 'AAAAAAA', 'AAAAAAA', false);
        });
