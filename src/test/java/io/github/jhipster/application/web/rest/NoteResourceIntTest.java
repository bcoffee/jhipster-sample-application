...
public class NoteResourceIntTest {
    ...
    private static final String DEFAULT_CYCLE_ID = "AAAAAAAAAA";
    private static final String UPDATED_CYCLE_ID = "BBBBBBBBBB";
    ...
    public void createNote() throws Exception {
        ...
        assertThat(testNote.getName()).isEqualTo(DEFAULT_NAME);
        assertThat(testNote.getLanguage()).isEqualTo(DEFAULT_LANGUAGE);
        assertThat(testNote.getMessage()).isEqualTo(DEFAULT_MESSAGE);
        assertThat(testNote.getCycleId()).isEqualTo(DEFAULT_CYCLE_ID);
    }
    ...
    public void getAllNotes() throws Exception {
        ...
        restNoteMockMvc.perform(get("/api/notes?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].cycleId").value(hasItem(DEFAULT_CYCLE_ID.toString())));
    }
    ...
    public void getNote() throws Exception {
        ...
        restNoteMockMvc.perform(get("/api/notes/{id}", note.getId()))
            ...
            .andExpect(jsonPath("$.cycleId").value(DEFAULT_CYCLE_ID.toString()));
    }
    ...
    public void updateNote() throws Exception {
        ...
        Note testNote = noteList.get(noteList.size() - 1);
        assertThat(testNote.getName()).isEqualTo(UPDATED_NAME);
        assertThat(testNote.getLanguage()).isEqualTo(UPDATED_LANGUAGE);
        assertThat(testNote.getMessage()).isEqualTo(UPDATED_MESSAGE);
        assertThat(testNote.getCycleId()).isEqualTo(UPDATED_CYCLE_ID);
    }
