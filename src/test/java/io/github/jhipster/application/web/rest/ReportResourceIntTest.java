...
public class ReportResourceIntTest {
    ...
    private static final byte[] DEFAULT_LAYOUT = TestUtil.createByteArray(1, "0");
    private static final byte[] UPDATED_LAYOUT = TestUtil.createByteArray(1, "1");
    private static final String DEFAULT_LAYOUT_CONTENT_TYPE = "image/jpg";
    private static final String UPDATED_LAYOUT_CONTENT_TYPE = "image/png";
    ...
    public static Report createEntity(EntityManager em) {
        Report report = new Report()
            ...
            .layoutContentType(DEFAULT_LAYOUT_CONTENT_TYPE);
        return report;
    }
    ...
    public void createReport() throws Exception {
        ...
        assertThat(testReport.getLanguage()).isEqualTo(DEFAULT_LANGUAGE);
        assertThat(testReport.getInstructions()).isEqualTo(DEFAULT_INSTRUCTIONS);
        assertThat(testReport.getLayout()).isEqualTo(DEFAULT_LAYOUT);
        assertThat(testReport.getLayoutContentType()).isEqualTo(DEFAULT_LAYOUT_CONTENT_TYPE);
    }
    ...
    public void getAllReports() throws Exception {
        ...
        restReportMockMvc.perform(get("/api/reports?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].layoutContentType").value(hasItem(DEFAULT_LAYOUT_CONTENT_TYPE)))
            .andExpect(jsonPath("$.[*].layout").value(hasItem(Base64Utils.encodeToString(DEFAULT_LAYOUT))));
    }
    ...
    public void getReport() throws Exception {
        ...
        restReportMockMvc.perform(get("/api/reports/{id}", report.getId()))
            ...
            .andExpect(jsonPath("$.layoutContentType").value(DEFAULT_LAYOUT_CONTENT_TYPE))
            .andExpect(jsonPath("$.layout").value(Base64Utils.encodeToString(DEFAULT_LAYOUT)));
    }
    ...
    public void updateReport() throws Exception {
        ...
        updatedReport
            ...
            .layoutContentType(UPDATED_LAYOUT_CONTENT_TYPE);
        ...
        assertThat(testReport.getLanguage()).isEqualTo(UPDATED_LANGUAGE);
        assertThat(testReport.getInstructions()).isEqualTo(UPDATED_INSTRUCTIONS);
        assertThat(testReport.getLayout()).isEqualTo(UPDATED_LAYOUT);
        assertThat(testReport.getLayoutContentType()).isEqualTo(UPDATED_LAYOUT_CONTENT_TYPE);
    }
